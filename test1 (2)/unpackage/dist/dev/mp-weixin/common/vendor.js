...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"test1","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 33 */
/*!***************************************************!*\
  !*** F:/testaaaaa/test1/uni.promisify.adaptor.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!***************************************************************!*\
  !*** F:/testaaaaa/test1/api/ink_painting/generatePainting.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.FALLBACK_INK_PAINTING = void 0;
exports.generateInkPainting = generateInkPainting;
var FALLBACK_INK_PAINTING = {
...
exports.FALLBACK_INK_PAINTING = FALLBACK_INK_PAINTING;
var GENERATE_ENDPOINT = '/api/ink-painting/generate';
    ...
    uni.request({
      ...
      success: function success(response) {
        if (response.statusCode < 200 || response.statusCode >= 300) {
          reject(new Error("Generate request failed: ".concat(response.statusCode)));
          return;
        }
        var source = response.data && (response.data.data || response.data);
        if (!source) {
...
/* 60 */
/*!****************************************************!*\
  !*** F:/testaaaaa/test1/api/poetry_image/index.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.requestPoetryImage = requestPoetryImage;
var API_URL = '/api/poetry-image/generate';
function requestPoetryImage() {
  var payload = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  if (!API_URL) {
